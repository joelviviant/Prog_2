...
public class ProductoCongelado extends Producto{
    ...
    public ProductoCongelado(String granjaOrigen, LocalDate fechaVencimiento, LocalDate fechaEnvasado, int numeroLote,int codigoAlimentaria, double temperaturaMantenimiento) {
